...
""",
    ...
    "עברית": {
        "title": "💬 מחפש קבוצת וואטסאפ",
        "intro": """
היי, אני **יונה** 👋  
כשעברתי לישראל, מצאתי המון ערך בקבוצות וואטסאפ מקומיות — אבל *שנאתי* לחפש אותן.
...
""",
        ...
        "email": "📧 האימייל שלך (כדי שאוכל לשלוח לך את הקישור — אל תשתמש ב'Hide Email')",
        "email_ph": "you@example.com",
